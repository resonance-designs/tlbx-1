...
use util::channel_layout::to_av_layout;
...
impl Context {
    ...
    pub fn get_with(
        ...
        unsafe {
            let mut out_layout = to_av_layout(dst_channel_layout);
            let mut in_layout = to_av_layout(src_channel_layout);
            ...
            let res = av_opt_set_dict(swr as *mut c_void, &mut opts);
            Dictionary::own(opts);

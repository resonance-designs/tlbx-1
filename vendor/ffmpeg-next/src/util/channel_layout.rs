...
bitflags! {
    pub struct ChannelLayout: c_ulonglong {
        ...
        const NATIVE                = AV_CH_LAYOUT_STEREO;
        ...
        const _3POINT1POINT2      = AV_CH_LAYOUT_3POINT1;
        #[cfg(feature = "ffmpeg_6_1")]
        const _5POINT1POINT2_BACK = AV_CH_LAYOUT_5POINT1_BACK;
        #[cfg(feature = "ffmpeg_6_1")]
        const _5POINT1POINT4_BACK = AV_CH_LAYOUT_5POINT1_BACK;
        #[cfg(feature = "ffmpeg_6_1")]
        const _7POINT1POINT2      = AV_CH_LAYOUT_7POINT1_WIDE;
        #[cfg(feature = "ffmpeg_6_1")]
        const _7POINT1POINT4_BACK = AV_CH_LAYOUT_7POINT1_WIDE_BACK;
    }
}
...
impl ChannelLayout {
    ...
    pub fn default(number: i32) -> ChannelLayout {
        unsafe {
            let mut layout: AVChannelLayout = mem::zeroed();
            av_channel_layout_default(&mut layout, number);
            ChannelLayout::from_bits_truncate(mask_from_av_layout(&layout) as c_ulonglong)
        }
    }
}

pub(crate) fn mask_from_av_layout(layout: &AVChannelLayout) -> u64 {
    if layout.order == AVChannelOrder::AV_CHANNEL_ORDER_NATIVE {
...
pub(crate) fn to_av_layout(layout: ChannelLayout) -> AVChannelLayout {
    unsafe {
        let mut out: AVChannelLayout = mem::zeroed();
        av_channel_layout_from_mask(&mut out, layout.bits());
        out
    }
}
